...
describe("T25 — le niveau est un rejeu, jamais un stock", () => {
  ...
  test("une cuisson journalisée fait descendre le placard", () => {
    const c = catalogue({
      ...
      plats: [plat({
        id: "dahl", portions: 4,
        ingredients: [{ id: "lentilles-seches", ref: "lentilles-seches", nom: "lentilles", qty: 200, unit: "g", base: false, assaisonnement: false, central: false }],
      })],
  ...
  test("les assaisonnements ne comptent jamais", () => {
    const p = plat({
      id: "x",
      ingredients: [
        { id: "sel", ref: "sel", nom: "sel", qty: 5, unit: "g", base: false, assaisonnement: true, central: false },
        { id: "mais", ref: "mais", nom: "maïs", qty: 100, unit: "g", base: false, assaisonnement: false, central: false },
      ],
    });
  ...
  test("les bases vont au dépôt, pas au placard", () => {
    const p = plat({
      id: "x",
      ingredients: [{ id: "lentilles-vertes-cuites", ref: "lentilles-vertes-cuites", nom: "lentilles cuites", qty: 250, unit: "g", base: true, assaisonnement: false, central: false }],
    });
  ...
  test("une unité qui n'est pas une masse ne se soustrait pas d'un poids", () => {
    const p = plat({
      id: "x",
      ingredients: [{ id: "ail", ref: "ail", nom: "ail", qty: 2, unit: "gousse", base: false, assaisonnement: false, central: false }],
    });
